# jarvis4.0_vscode router state (local-only)
...
1. `agents/jarvis4.0_vscode_state.md` (this file)
...
3. If **Yes**:
   ...
   - Copy agent config bundle (`.github/agents/`, `agents/` structure).
...
This agent variant prioritizes:

- Fast iteration with local builds
- Direct terminal access for debugging
- File system watching for live reload
- Local language server features (gopls, rust-analyzer)
