...
| Agent | File | Runtime | Status |
|-------|------|---------|--------|
| `jarvis5.0` | `.github/agents/jarvis5.0.agent.md` | GitHub Copilot CLI | **Active** |
| `jarvis5.0_vscode` | `.github/agents/jarvis5.0_vscode.agent.md` | VSCode Copilot | **Active** |
| `reviewer` | `.github/agents/reviewer.agent.md` | PR review gatekeeper | **Active** |
